...
/* - No sync signal is generated by 6510 - so we need to figure out an alternative way to disassemble */
#if 0
			if (MAIN_PinGetPIN_SYNC())
			{
			lastPC=addr;		// TODO: will disassemble mid instructions at present!
