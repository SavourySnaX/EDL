...
{
private:
	llvm::Value* GenerateAlways(CodeGenContext& context, BitVariable& pin, llvm::Value* function);
	llvm::Value* GenerateChanged(CodeGenContext& context, BitVariable& pin, llvm::Value* function);
	llvm::Value* GenerateTransition(CodeGenContext& context, BitVariable& pin, llvm::Value* function);
public:
	int type;
	CInteger& param1;
	CInteger& param2;
